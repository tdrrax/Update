...
for brayen in range(10000):
    rr = random.randint
    rc = random.choice
    u1 = f"Mozilla/5.0 (Linux; Android 11 {str(rr(4,12))};SHARK MBU-H0 Build/MOBS2208200OS00MR2{str(rr(111111,210000))}; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome {str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/465.0.0.63.83;]"
    u2 = f"Mozilla/5.0 (Linux; Android 14 {str(rr(4,12))}; 22061218C Build/UKQ1.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/465.0.0.63.83;]"
    u3 = f"Mozilla/5.0 (Linux; Android 11 {str(rr(4,12))}; MiTV-AYFR0 Build/RTT0.{str(rr(111111,210000))}.001; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36"
    u4 = f"Mozilla/5.0 (Linux; Android 14 {str(rr(4,12))}; 22101320C Build/UKQ1.{str(rr(111111,210000))}.002; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/465.0.0.63.83;]"
    u5 = f"Mozilla/5.0 (Linux; Android 14 {str(rr(4,12))}; 23078RKD5C Build/UP1A.{str(rr(111111,210000))}.011; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/{str(rr(73,150))}.0.{str(rr(5500,5900))}.{str(rr(75,150))} Mobile Safari/537.36 [FB_IAB/FB4A;FBAV/465.0.0.63.83;]"
